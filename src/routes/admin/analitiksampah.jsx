...
import { Video, CheckCircle2, AlertTriangle, Download, Plus, X, Trash, PencilLine, ChevronLeft, ChevronRight, Clock } from "lucide-react";
        ...
        <div className="flex flex-col gap-y-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <motion.div whileHover={{ y: -10 }} className="card">
                    <div className="card-header">
                        ...
                        <p className="card-title">Total CCTV</p>
                    </div>
                    <div className="card-body bg-slate-100">
                        <p className="text-3xl font-bold text-center text-slate-900">{wasteList.length}</p>
                        <p className="text-sm text-center text-gray-500">unit terpasang</p>
                    </div>
                </motion.div>

                <motion.div whileHover={{ y: -10 }} className="card">
                    <div className="card-header">
                        <div className="p-2 text-red-500 rounded-lg w-fit bg-red-500/20">
                    ...
                    <div className="card-body bg-slate-100">
                        ...
                        <p className="text-sm text-center text-gray-500">{peakHour.count} deteksi</p>
                    </div>
                </motion.div>
                ...
                <motion.div whileHover={{ y: -10 }} className="card">
                    ...
                    <div className="card-body bg-slate-100">
                        ...
                        <p className="text-sm text-center text-gray-500">{lowHour.count} deteksi</p>
                    </div>
                </motion.div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 mt-1 text-center md:grid-cols-3">
                <motion.div className="p-4 bg-green-100 border-l-4 border-r-4 border-green-500 shadow-lg rounded-xl">
                    ...
                    <p className="mt-1 text-gray-700">0-50% kapasitas</p>
                </motion.div>
                ...
                <motion.div className="p-4 bg-yellow-100 border-l-4 border-r-4 border-yellow-500 shadow-lg rounded-xl">
                    ...
                    <p className="mt-1 text-gray-700">50-100% kapasitas</p>
                </motion.div>
                ...
                <motion.div className="p-4 bg-red-100 border-l-4 border-r-4 border-red-500 shadow-lg rounded-xl">
                    ...
                    <p className="mt-1 text-gray-700">&gt; 100% kapasitas</p>
                </motion.div>
            </div>
            ...
            <h1 className="mt-4 font-bold text-center">Distribusi Status Tumpukan</h1>
            <div className="card">
                <div className="w-full h-80">
                    <ResponsiveContainer width="100%" height="100%">
            ...
            {/* Pie Chart */}
            <h1 className="mt-4 font-bold text-center">Persentase Status Tumpukan</h1>
            <div className="card">
                <div className="w-full h-80">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
            ...
            {/* Map Section */}
            <h1 className="mt-8 mb-2 font-bold text-center">Sebaran CCTV Tumpukan Sampah Kabupaten Banyuwangi</h1>
            <div className="card">
                            ...
                            <table className="table w-full">
                                <thead className="text-xs uppercase bg-gray-100">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-4 py-3">Nama TPS</th>
                                        <th scope="col" className="px-4 py-3">Alamat</th>
                                        <th scope="col" className="px-4 py-3">Koordinat</th>
                                        <th scope="col" className="px-4 py-3">Presentase</th>
                                ...
                                <tbody>
                                    {wasteList.map((item, index) => (
                                        <tr key={index} className="bg-white border-b">
                                            ...
                                            <td className="px-4 py-2">
                                                {item.presentase ? `${item.presentase}%` : '-'}
                                            </td>
                                            <td className="px-4 py-2">
                                                {item.status ? (
